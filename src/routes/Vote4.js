...
const Vote4 = () => {
    ...
    const fetchData = async (e) => {
        try {
            const docRef = doc(dbService, "votes", "vote4");
    ...
    const voteA = async(e) => {
        e.preventDefault();
        fetchData();
        await updateDoc(doc(dbService,"votes",`vote4`),{
            countA: numA + 1
        });
        toast('투표 완료!');
    }
    ...
    return(
        <>
            ...
            <div className="container">
                ...
                <br></br><br></br><br></br>
                <label className="vote1Title">둘 중 더 최악의 고통은?</label>
                ...
                <div className="voteBtn">
                    <button className="formChoicebtn1" style={{ marginRight: 20, backgroundColor:"yellowGreen"}} onClick={voteA} >평생두통</button>
                    <button className="formChoicebtn1" style={{ marginLeft: 20, backgroundColor:"darkgreen"}} onClick={voteB} >평생치통</button>
                </div>
            </div>
        </>
